...
const COLLEGES = {
  ...
  'Bryant University': 'American East Conference',
  ...
  'California Polytechnic State University - San Luis Obispo': 'Big Sky Conference',
  ...
  'Chicago State University': 'Ohio Valley Conference',
  ...
  'Florida Atlantic University': 'The american athletic Conference',
  ...
  'Fordham University': 'Patriot League',
  ...
  'Georgetown University': 'Patriot League',
  ...
  'Hampton University': 'Colonial Athletic Association',
  ...
  'Monmouth University': 'Mid-Eastern Athletic Conference',
  ...
  'New Jersey Institute of Technology': 'American East Conference',
  'New Mexico State University': 'Sun Belt Conference',
  ...
  'North Carolina A&T State University': 'Mid-Eastern Athletic Conference',
  ...
  'Old Dominion University': 'Sunbelt Conference',
  ...
  'Queens University of Charlotte': 'Atlantic Sun Conference',
  ...
  'Robert Morris University - Pennsylvania': 'Northeast Conference',
  ...
  'Sam Houston State University': 'Western Athletic Conference',
  ...
  'South Dakota State University': 'Summit League Conference',
  ...
  'Southern Methodist University - SMU': 'American Athletic Conference',
  ...
  'Stanford University': 'Pacific-12 Conference',
  'Stephen F Austin State University': 'Western Conference',
  'Stetson University': 'Metro Atlantic Athletic Conference',
  'Stonehill College': 'Northeast Conference',
  'SUNY Binghamton University': 'America East Conference',
  'SUNY Stony Brook University': 'Colonial Athletic Association',
  'SUNY University at Albany': 'America East Conference',
  'SUNY University at Buffalo': 'Mid-American Conference',
  'Syracuse University': 'American Athletics Conference',
  ...
  'Texas A&M University - Commerce': 'Lone Star Conference',
  ...
  'University of Arizona': 'Pacific-12 Conference',
  ...
  'University of California - Berkeley': 'Pacific-12 Conference',
  'University of California - Davis': 'Big Sky Conference',
  'University of California - Irvine': 'Big West Conference',
  'University of California - Los Angeles - UCLA': 'Pacific-12 Conference',
  ...
  'University of Colorado - Boulder': 'Pacific-12 Conference',
  ...
  'University of Hawaii at Manoa': 'Mountain West Conference',
  ...
  'University of Notre Dame': 'Division I-A Independents',
  ...
  'University of Rhode Island': 'Atlantic Ten Conference',
  ...
  'University of Southern California': 'Pacific-12 Conference',
  'University of Southern Mississippi': 'Sun Belt Conference',
  'University of St. Thomas - Minnesota': 'The Summit League',
  ...
  'Washington State University': 'Pacific-12 Conference',
...
const renderGuesses = (colleges, guesses) => {
  ...
  return [...Array(maxGuesses)].map((_, guessIndex) => {
    ...
    const classes = Object.entries({
      ...
      correctConference: hasGuess && !isCorrect && colleges.some((c) => COLLEGES[guess] === COLLEGES[c]),
...
const renderResultEmoji = (guesses, roundIndex) => {
  ...
  return [...Array(maxGuesses)].map(
    (_, i) => {
      ...
      if (colleges.some((c) => COLLEGES[guesses[i]] === COLLEGES[c])) {
